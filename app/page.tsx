...
const previewCards: PreviewCard[] = [
  {
    ...
    image: "/preview-tiktok.svg",
    imageAlt: "TikTok output preview generated by Video8n",
    note: "Hook score up 18%",
    platform: "TikTok",
    ratio: "9:16",
    tone: "vertical",
  },
  {
    ...
    image: "/preview-youtube.svg",
    imageAlt: "YouTube output preview generated by Video8n",
    note: "Chapters drafted",
    platform: "YouTube",
    ratio: "16:9",
    tone: "wide",
  },
  {
    ...
    image: "/preview-facebook.svg",
    imageAlt: "Facebook output preview generated by Video8n",
    note: "Queue synced",
    platform: "Facebook",
    ratio: "1:1",
    tone: "square",
...
const steps: StepCard[] = [
  ...
  {
    title: "Generate",
    copy: "Pypple's AI produces a platform-ready video in seconds.",
  },
  {
    title: "Publish",
...
export default function Home() {
          ...
          <section className="section hero" id="hero">
            <div className="container hero-grid">
              <div className="reveal is-visible" data-reveal>
                <p className="eyebrow">[ PYPPLE TECHNOLOGY ]</p>
                <h1>Your Content, Everywhere, Instantly.</h1>
                <p className="section-copy hero-copy">
                  Scale your presence with a Pypple-powered AI engine that turns
              ...
              <div className="preview-grid">
                {previewCards.map((card) => (
                  ...
                  >
                    ...
                    <div className={`preview-stage preview-stage--${card.tone}`}>
                      <Image
                        src={card.image}
                        alt={card.imageAlt}
                        fill
                        sizes="(max-width: 768px) 100vw, (max-width: 1100px) 90vw, 33vw"
                        className="preview-stage__image"
                      />
                      <div className="preview-stage__overlay">
                        <span className="preview-stage__tag">AI-ready export</span>
                        <span className="preview-stage__status">{card.note}</span>
                      </div>
                      <div className="preview-stage__footer">
                        <span>Rendered by Video8n</span>
                        <span>{card.ratio} optimized</span>
                      </div>
                    </div>
  ...
  "issuer": "Pypple Technology"
                ...
                <div className="safety-side">
                  ...
                  <article className="glass-card safety-mini reveal" data-reveal>
                    ...
                    <div className="badge-row">
                      <span className="review-badge">Product of Pypple Technology</span>
      ...
      <style jsx global>{`
        ...
        .preview-stage__status {
          background: color-mix(in srgb, var(--card-accent) 14%, rgba(5, 8, 18, 0.66));
          border: 1px solid color-mix(in srgb, var(--card-accent) 28%, rgba(255, 255, 255, 0.08));
          color: color-mix(in srgb, var(--card-accent) 76%, white);
        }
